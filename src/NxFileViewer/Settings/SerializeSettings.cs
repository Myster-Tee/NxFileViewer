...
/// </summary>
public class SerializeSettings : ISerializedSettings
{
    ...
    public bool AlwaysReloadKeysBeforeOpen { get; set; } = false;
    ...
    public string RenameWhiteSpaceCharsReplacement { get; set; } = "_";
}